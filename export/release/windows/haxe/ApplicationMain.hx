...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NOVISOR", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("NOVISOR", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "8";
		app.meta["company"] = "crazyfirey";
		app.meta["file"] = "NOVISOR";
		app.meta["name"] = "Novisor V2";
