...
HXLINE(  73)		::ClientPrefs_obj::startControls();
HXLINE(  74)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
HXLINE(  77)		::Main_obj::fpsVar =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  78)		this->addChild(::Main_obj::fpsVar);
HXLINE(  79)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  80)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
