...
HXLINE( 212)					ret = linc::lua::tostring(l,v);
            				...
            				break;
            				case (int)5: {
HXLINE( 212)					ret = ::llua::Convert_obj::toHaxeObj(l,v);
            				}
            				break;
            				default:{
HXLINE( 212)					ret = null();
HXDLIN( 212)					 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 212)					::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(v)));
HXDLIN( 212)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            				}
            			}
...
HXLINE( 244)				ret = linc::lua::tostring(l,-1);
            			...
            			break;
            			case (int)5: {
HXLINE( 244)				ret = ::llua::Convert_obj::toHaxeObj(l,-1);
            			}
            			break;
            			default:{
HXLINE( 244)				ret = null();
HXDLIN( 244)				 ::Dynamic this1 = ::haxe::Log_obj::trace;
HXDLIN( 244)				::String this2 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 244)				this1(this2,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            			}
            		}
