...
static const ::String _hx_array_data_205e8859_1[] = {
	HX_("story_mode",2d,63,e6,a4),HX_("freeplay",a0,90,86,22),HX_("options",5e,33,fe,df),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_238_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",238,0x0e5db805)
...
HXDLIN( 150)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 151)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 153)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 153)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXLINE( 190)					if ((::MainMenuState_obj::curSelected != spr->ID)) {
...
HXLINE( 192)						::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 204)							::String daChoice = _gthis->optionShit->__get(::MainMenuState_obj::curSelected);
HXLINE( 206)							::String _hx_switch_0 = daChoice;
            							if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 211)								::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 211)								goto _hx_goto_5;
            							}
            							if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 213)								::MusicBeatState_obj::switchState( ::OptionsState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 213)								goto _hx_goto_5;
            							}
            							if (  (_hx_switch_0==HX_("story_mode",2d,63,e6,a4)) ){
HXLINE( 209)								::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 209)								goto _hx_goto_5;
            							}
            							_hx_goto_5:;
            						}
            						HX_END_LOCAL_FUNC1((void))

HXLINE( 202)						::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            					}
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 183)				this->selectedSomethin = true;
HXLINE( 184)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 184)				_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 186)				if (::ClientPrefs_obj::flashing) {
HXLINE( 186)					::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            				}
HXLINE( 188)				this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            			}
            			else {
HXLINE( 221)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 221)				if (_this->keyManager->checkStatus(55,_this->status)) {
HXLINE( 223)					this->selectedSomethin = true;
HXLINE( 224)					::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
            				}
            			}
            		}
HXLINE( 229)		this->super::update(elapsed);
HXLINE( 231)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
HXLINE( 249)			spr->offset->set_y(( (Float)(0) ));
HXLINE( 250)			spr->updateHitbox();
HXLINE( 252)			if ((spr->ID == ::MainMenuState_obj::curSelected)) {
HXLINE( 254)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 255)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 255)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 255)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
HXLINE( 256)				spr->offset->set_x((((Float)0.15) * ((( (Float)(spr->frameWidth) ) / ( (Float)(2) )) + 180)));
HXLINE( 257)				spr->offset->set_y((((Float)0.15) * ( (Float)(spr->frameHeight) )));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_238_changeItem)
HXDLIN( 238)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 239)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::MainMenuState >();
HXDLIN( 239)		::MainMenuState_obj::curSelected = (::MainMenuState_obj::curSelected + huh);
HXLINE( 241)		if ((::MainMenuState_obj::curSelected >= this->menuItems->length)) {
HXLINE( 242)			::MainMenuState_obj::curSelected = 0;
            		}
HXLINE( 243)		if ((::MainMenuState_obj::curSelected < 0)) {
HXLINE( 244)			::MainMenuState_obj::curSelected = (this->menuItems->length - 1);
            		}
