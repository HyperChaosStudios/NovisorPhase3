...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("NOVISOR",02,67,b1,f6),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("crazyfirey",52,08,71,2b));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("NOVISOR",02,67,b1,f6));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Novisor V2",7a,25,e3,a8));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Novisor V2",7a,25,e3,a8))
