...
HX_DEFINE_STACK_FRAME(_hx_pos_ec6539926560d3c0_90_new,"AttachedAchievement","new",0x78b415bd,"AttachedAchievement.new","Achievements.hx",90,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_97_changeAchievement,"AttachedAchievement","changeAchievement",0x3f6c6afc,"AttachedAchievement.changeAchievement","Achievements.hx",97,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_102_reloadAchievementImage,"AttachedAchievement","reloadAchievementImage",0x2581b6a8,"AttachedAchievement.reloadAchievementImage","Achievements.hx",102,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_114_update,"AttachedAchievement","update",0x63d738cc,"AttachedAchievement.update","Achievements.hx",114,0xf249f7fa)

void AttachedAchievement_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String name){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_90_new)
HXLINE(  91)		super::__construct(x,y,null());
HXLINE(  93)		this->changeAchievement(name);
...
void AttachedAchievement_obj::changeAchievement(::String tag){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_97_changeAchievement)
HXLINE(  98)		this->tag = tag;
HXLINE(  99)		this->reloadAchievementImage();
            	}
...
void AttachedAchievement_obj::reloadAchievementImage(){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_102_reloadAchievementImage)
HXLINE( 103)		if (::Achievements_obj::isAchievementUnlocked(this->tag)) {
HXLINE( 104)			::String library = null();
HXDLIN( 104)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("achievementgrid",b5,fa,02,8a));
HXDLIN( 104)			 ::Dynamic _hx_tmp;
HXDLIN( 104)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 104)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE( 104)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("achievementgrid",b5,fa,02,8a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN( 104)			this->loadGraphic(_hx_tmp,true,150,150,null(),null());
HXLINE( 105)			 ::flixel::animation::FlxAnimationController _hx_tmp1 = this->animation;
HXDLIN( 105)			_hx_tmp1->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,::Achievements_obj::getAchievementIndex(this->tag)),0,false,false,null());
HXLINE( 106)			this->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
            		}
            		else {
HXLINE( 108)			::String library = null();
HXDLIN( 108)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("lockedachievement",a5,23,f4,2a));
HXDLIN( 108)			 ::Dynamic _hx_tmp;
HXDLIN( 108)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 108)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE( 108)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("lockedachievement",a5,23,f4,2a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN( 108)			this->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
            		}
HXLINE( 110)		this->scale->set(((Float)0.7),((Float)0.7));
...
void AttachedAchievement_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_114_update)
HXLINE( 115)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE( 116)			this->setPosition((this->sprTracker->x - ( (Float)(130) )),(this->sprTracker->y + 25));
            		}
