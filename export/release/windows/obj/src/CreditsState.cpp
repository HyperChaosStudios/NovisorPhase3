...
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_52_create,"CreditsState","create",0x506b2cd3,"CreditsState.create","CreditsState.hx",52,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_102_update,"CreditsState","update",0x5b614be0,"CreditsState.update","CreditsState.hx",102,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_135_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",135,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_153_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",153,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_176_unselectableCheck,"CreditsState","unselectableCheck",0x4473c3a2,"CreditsState.unselectableCheck","CreditsState.hx",176,0xdb40a967)
...
void CreditsState_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_1bf4423a091ce525_52_create)
HXLINE(  55)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
HXLINE(  58)		 ::flixel::FlxSprite _hx_tmp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE(  58)			_hx_tmp1 = imageToReturn;
            		}
            		else {
HXLINE(  58)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN(  58)		this->bg = _hx_tmp->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE(  59)		this->add(this->bg);
HXLINE(  61)		this->grpOptions =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  62)		this->add(this->grpOptions);
HXLINE(  64)		{
HXLINE(  64)			int _g = 0;
HXDLIN(  64)			int _g1 = ::CreditsState_obj::creditsStuff->get_length();
HXDLIN(  64)			while((_g < _g1)){
HXLINE(  64)				_g = (_g + 1);
HXDLIN(  64)				int i = (_g - 1);
HXLINE(  66)				bool isSelectable = !(this->unselectableCheck(i));
HXLINE(  67)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),( (::String)(::CreditsState_obj::creditsStuff->__get(i)->__GetItem(0)) ),!(isSelectable),false,null(),null());
HXLINE(  68)				optionText->isMenuItem = true;
HXLINE(  69)				optionText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  70)				if (isSelectable) {
HXLINE(  71)					optionText->set_x((optionText->x - ( (Float)(70) )));
            				}
HXLINE(  73)				optionText->forceX = optionText->x;
HXLINE(  75)				optionText->targetY = ( (Float)(i) );
HXLINE(  76)				this->grpOptions->add(optionText).StaticCast<  ::Alphabet >();
HXLINE(  78)				if (isSelectable) {
HXLINE(  79)					 ::AttachedSprite icon =  ::AttachedSprite_obj::__alloc( HX_CTX ,(HX_("credits/",d5,48,ee,de) + ::CreditsState_obj::creditsStuff->__get(i)->__GetItem(1)),null(),null(),null());
HXLINE(  80)					icon->xAdd = (optionText->get_width() + 10);
HXLINE(  81)					icon->sprTracker = optionText;
HXLINE(  84)					this->iconArray->push(icon);
HXLINE(  85)					this->add(icon);
            				}
            			}
            		}
HXLINE(  89)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,50,600,1180,HX_("",00,00,00,00),32,null());
HXLINE(  90)		this->descText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  91)		this->descText->scrollFactor->set(null(),null());
HXLINE(  92)		this->descText->set_borderSize(((Float)2.4));
HXLINE(  93)		this->add(this->descText);
HXLINE(  95)		this->bg->set_color(( (int)(::CreditsState_obj::creditsStuff->__get(this->curSelected)->__GetItem(4)) ));
HXLINE(  96)		this->intendedColor = this->bg->color;
...
void CreditsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_1bf4423a091ce525_102_update)
HXLINE( 103)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 105)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 105)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 108)		bool upP = ::PlayerSettings_obj::player1->controls->_ui_upP->check();
HXLINE( 109)		bool downP = ::PlayerSettings_obj::player1->controls->_ui_downP->check();
HXLINE( 111)		if (upP) {
...
HXLINE( 120)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 122)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 123)				this->colorTween->cancel();
            			}
HXLINE( 125)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 125)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 126)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 128)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 129)			::CoolUtil_obj::browserLoad(( (::String)(::CreditsState_obj::creditsStuff->__get(this->curSelected)->__GetItem(3)) ));
            		}
...
void CreditsState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_135_changeSelection)
HXDLIN( 135)		 ::CreditsState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 136)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 136)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 137)		while(true){
HXLINE( 138)			 ::CreditsState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 138)			_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 139)			if ((this->curSelected < 0)) {
HXLINE( 140)				this->curSelected = (::CreditsState_obj::creditsStuff->get_length() - 1);
            			}
HXLINE( 141)			if ((this->curSelected >= ::CreditsState_obj::creditsStuff->get_length())) {
HXLINE( 142)				this->curSelected = 0;
            			}
HXLINE( 137)			if (!(this->unselectableCheck(this->curSelected))) {
HXLINE( 137)				goto _hx_goto_4;
            			}
            		}
            		_hx_goto_4:;
HXLINE( 145)		int newColor = ( (int)(::CreditsState_obj::creditsStuff->__get(this->curSelected)->__GetItem(4)) );
HXLINE( 146)		if ((newColor != this->intendedColor)) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CreditsState,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_153_changeSelection)
HXLINE( 153)				_gthis->colorTween = null();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 147)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 148)				this->colorTween->cancel();
            			}
HXLINE( 150)			this->intendedColor = newColor;
HXLINE( 151)			this->colorTween = ::flixel::tweens::FlxTween_obj::color(this->bg,1,this->bg->color,this->intendedColor, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_0(_gthis)))));
            		}
HXLINE( 158)		int bullShit = 0;
HXLINE( 160)		{
HXLINE( 160)			int _g = 0;
HXDLIN( 160)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 160)			while((_g < _g1->length)){
HXLINE( 160)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 160)				_g = (_g + 1);
HXLINE( 162)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 163)				bullShit = (bullShit + 1);
HXLINE( 165)				if (!(this->unselectableCheck((bullShit - 1)))) {
HXLINE( 166)					item->set_alpha(((Float)0.6));
...
HXLINE( 172)		this->descText->set_text(( (::String)(::CreditsState_obj::creditsStuff->__get(this->curSelected)->__GetItem(2)) ));
            	}
...
bool CreditsState_obj::unselectableCheck(int num){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_176_unselectableCheck)
HXDLIN( 176)		return ::hx::IsLessEq( ::CreditsState_obj::creditsStuff->__get(num)->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic),1 );
            	}
